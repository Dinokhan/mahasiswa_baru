                ...
                <div class="col-md-8 blog-main">
                  <div class="post-detail sep-bottom-lg">
                    <div class="post-detail-body sep-xs">
                      ...
                      <img src="blog/12.jpg"><br><br><br>
                        <p style="font-size: 13px" align="justify">
                        To create its Inter-university networking, UNIDA Gontor has signed a Memorandum of Understanding with many universities, inland and abroad. The universities that have signed MoUs with UNIDA Gontor are as follows:<br>
                        </p>
                        <br>
                      <ol>
                        <li>International Islamic University, Malaysia. November 11, 2000</li>
                        <li>Institute of Leadership and Management, Lahore, Pakistan. May 10, 2002</li>
                        <li>University of Malaya, Malaysia. 2005</li>
                        <li>Indonesia Islamic University, Yogyakarta. May 20, 2006</li>
                        <li>State Islamic University, Makasar. 2006</li>
                      </ol>
                    </div>
                  </div>
                </div>
