                ...
                <div class="col-md-8 blog-main">
                  <div class="post-detail sep-bottom-lg">
                    <div class="post-detail-body sep-xs">
                      <h4 class="text-uppercase">Students Organization (en)</h4>
                      <span class="line-sep-gray"></span>
                      <img src="blog/13.jpg"><br><br><br>
                      <h5>Research and Social Service Department</h5>
                        <p style="font-size: 13px" align="justify">
                        This Departement undertakes various routine activities to develop the student skills, such as religious speech presentation through Suara Gontor Radio, teaching Al-Quran, intensive study week, spiritual enhancement, and seminars.<br>
                        </p>
                        <br>
                      <h5>Publication Department</h5>
                        <p style="font-size: 13px" align="justify">
                        The Students Union regularly publishes magazine, bulletin, and pamphlets such as Himmah, Pusaka, Lentera, Risalah Dakwah, Tajdid, Nahdhah, and . The purpose of thes activities is to develop the students’ writing and publishing skills.<br>
                        </p> <br> 
                      <h5>Scout Movement</h5>
                        <p style="font-size: 13px" align="justify">
                        Routine activities organized by this department include training on scouting, camping, and hiking.</p><br>
                      <h5>Sport Department</h5>
                        <p style="font-size: 13px" align="justify">
                        Sport facilities are provided for the following games: basket ball, badminton, takraw ball, volley ball, table-tennis, and martial arts. The department is responsible for the management of sport activities both inside and outside the campus.<br>  
                        </p> <br>
                      <h5>Arts Department</h5>
                        <p style="font-size: 13px" align="justify">
                        In order to develop creative skill and art appreciation, UNIDA Gontor organizes various lessons and shows such as martial art, theater, and the art of al-Qur’an recitation.<br>  
                        </p> <br>
                    </div>
                  </div>
                </div>
