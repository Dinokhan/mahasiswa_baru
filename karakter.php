                ...
                <div class="col-md-8 blog-main">
                  <div class="post-detail sep-bottom-lg">
                    <div class="post-detail-body sep-xs">
                      <h3 class="text-uppercase">Characteristics (en)</h3>
                      <span class="line-sep-gray"></span>

                        <p>
                        UNIDA Gontor is widely known as the only private Islamic institution of higher learning in Indonesia that since its inception has adopted Arabic and English both as the medium of instruction and communication, where students write their papers and dissertation in these languages. In addition, UNIDA Gontor has also adopted a total boarding system where the mosque, hostel, lecture rooms, library, laboratories, sport-ground, lecturer houses and other facilities are located inside the campus, thereby creating an environment conducive for intensive learning and interaction between students and lecturers. This exclusive boarding system is significantly promising for the cultivation of Islamic values such as brotherhood, sincerity, simplicity, tolerance, the spirit of self-reliance, leadership, etc. With this integrated system of higher education UNIDA is designed to realize its vision and mission.
                        </p>
