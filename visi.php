                ...
                <div class="col-md-8 blog-main">
                  <div class="post-detail sep-bottom-lg">
                    <div class="post-detail-body sep-xs">
                      <h3 class="text-uppercase">Vision & Mission (en)</h3>
                      <span class="line-sep-gray"></span>
                        ...
                        <p>
                        <h4>MISSION</h4>
                            1. To carry out the activities of higher learning in order to develop science, technology, humanities from the Islamic perspective to respond the global challenges.
                            <br><br>
                            2. To play an important role in developing science, technology, and arts through research and social services in order to develop Islamic civilization for the welfare of Ummah and the nation of Indonesia.
                        </p>
                        <br><br>
                        <p>
                        <h4>AIM</h4>
                            1. To produce pious Muslim, who has noble character and wide knowledge and has capability to deepen and develop his knowledge creatively and innovatively to solve the problems of Ummah and the nation, so then ready to compete through the program of diploma, bachelor, master and profession nationally and internationally.
                            <br><br>
                            2. TTo be the center of scientific development, technology and arts based on Islamic values to respond the global challenges.
                            <br><br>
                            3. To produce anticipative and adoptable research that is valuable for mankind in general in order to compete the future challenges.
                        </p>
