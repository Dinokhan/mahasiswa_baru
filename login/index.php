      ...
      <div class="col-md-12">
        ...
        <div class="row">
          <div class="col-md-4 col-md-offset-8 col-lg-offset-8 mar-bottom-md">
            <h1 class="text-uppercase text-primary wow fadeInDown text-center"  data-wow-duration=".8s" data-wow-delay=".2s">LOGIN</h1>
            <p class="text-center">
              <b class="text-muted text-capitalize">Admin & User</b>
            </p>
            <div class="text-center">
              <span class="separator">
                <i class="icon icon-small iline2-lock22 text-primary no-margin"></i>
              </span>
            </div>
            ...
            <form action="login.php" method="post" class="mar-top-lg error wow fadeInUp"  data-wow-duration="1s" data-wow-delay=".6s" novalidate="">
              <div class="form-group control-group">
                <input type="text" class="form-control input-lg" id="name" name="username" placeholder="Username" type="text" required="" data-validation-required-message="Please enter your username.">
                <p class="help-block"></p>
              </div>
              <div class="form-group control-group">
                <input type="password" class="form-control input-lg" id="password" name="password" placeholder="**********" type="password" required="" data-validation-required-message="Please enter your password.">
                <p class="help-block"></p>
              </div>
              <div class="checkbox control-group">
              </div>
              <button class="btn btn-primary btn-full btn-lg" type="submit" name="login" id="login" value="Login">Submit</button>
            </form>
          </div>
        </div>
        <!-- /.row -->
