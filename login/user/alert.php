                ...
                <div class="carousel-inner" role="listbox">
                  <div class="item active">
                    <div class="carousel-caption">
                      <span class="caption-head" data-animation="animated bounceInLeft"><span class="text-success" style=""></span><span class="text-success" style=""></span><br>  Pengisian Data <br> Telah Selesai <br>SILAHKAN MASUKKAN PILIHAN</span>

                      <br><br><br><br>
                      <div class="col-md-7 footer-grid" data-animation="animated zoomInUp">
                       <img src="../../images/ami10.png"><br>
                       <a class="btn btn-primary btn-lg" data-animation="animated zoomInUp" href="../index.php">LOGIN</a>
                     </div>
                     <div class="col-md-2 footer-grid" data-animation="animated zoomInUp">
                       <img src="../../images/ami9.png"><br>
                       <a class="btn btn-primary btn-lg" data-animation="animated zoomInUp" href="../../index.php">HOME</a>
                     </div>
