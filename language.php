                ...
                <div class="col-md-8 blog-main">
                  <div class="post-detail sep-bottom-lg">
                    <div class="post-detail-body sep-xs">
                      <h4 class="text-uppercase">Language Center</h4>
                      <span class="line-sep-gray"></span>
                      <img src="blog/11.jpg"><br><br><br>
                        <p style="font-size: 13px" align="justify">
                        The primary task of Language Center is to maximize the exploration and use of available resources in order to assist the students in mastering both Arabic and English, the main language of science and civilization. The programs organized by the center include: Arabic language courses after Dzuhur prayer in class, English language courses every morning in the language laboratory, scientific discussion in Arabic and English in every Tuesday morning at the Jami ‘, seven minutes lecture after Maghrib prayer in Arabic and English. Also, Language Center of UNIDA Gontor routinely carries Arabic language learning program for two to three months followed by foreign students; Islamic Science University of Malaysia (USIM), International Islamic University College Selangor (KUIS), Sultan Idris Education University of Malaysia (UPSI), and students from Turkey and France.<br>
                        </p>
                        <br>
